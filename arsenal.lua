...
local Window = OrionLib:MakeWindow({Name = "MSNRoHub arsenal", IntroText = "MSNRoHub", HidePremium = false, SaveConfig = false})
 
OrionLib:MakeNotification({
	Name = "MSNRoHub Notifier",
...
local ChatMsg = "MSNRoHub on top"
PlayerTab:AddTextbox({
	Name = "Chat Message",
	Default = "MSNRoHub on top",
	TextDisappear = false,
	Callback = function(a)
		ChatMsg = a
	end
